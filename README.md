...
```json
{
    ...
    "Values": {
        ...
        "AppVersion": "0.0.1",
        "BetterStack__Endpoint": "https://something.betterstackdata.com",
        "BetterStack__SourceToken": "super_secret",
        ...
        "Serilog__MinimumLevel__Override__Microsoft.Hosting": "Warning",
